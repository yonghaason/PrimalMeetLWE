...
# dep_test(l = 5, r = 20, c = 40, stddev = 1, Rscale = 3)
...
def dep_test(l1, l2, r, stddev, Rscale = 1, repeat=10000): 

  E_p_rep = 1.0
  for i in range(r):
    E_p_rep *= p_adm_unif(l1, 2*l2)
  ...
  print("p_sp(v): Prob of at least one rep pairs of v exists in [-%d, %d]^%d (in volume %d space)" % (l2, l2, r, 1/scaler))
  ...
  print("* Experiment 1: e_1 - e_1 = e_0 (Gaussian of std.dev %f)" % stddev)  
  E_p_sp1 = 0.0
  E_p_sp2 = 0.0
  E_p_L = 0.0
  ...
  for i in range(r):
    error[i] = np.random.normal(scale=stddev)
  ...
  print("Experiment 2: e1 & e2 are independent")
  E_p_sp1 = 0.0
  E_p_sp2 = 0.0
  E_p_L = 0.0
...
def double_dep_test(l1, l2, l3, r, stddev, Rscale = 1, repeat=10000):
  assert l1 <= l2, "l1 should be smaller than l2"

  E_p_rep = 1.0
  for i in range(r):
    E_p_rep *= p_adm_unif(l2, 2*l3)
  ...
  print("******* Goal of this experiment **********")
  print("p_sp(v) := At least one rep pairs of v in [-%d, %d]^%d (in volume %d space)" % (l3, l3, r, 1/scaler))
  ...
  print("* Experiment 1: e_11 - e_12 = e_0 (Gaussian of std.dev %f)" % stddev)
  ...
  for i in range(r):
    e_0[i] = np.random.normal(scale=stddev)
  ...
  print("* Experiment 3: All e_21 ... e_24 are independent")
  E_p_sp1 = 0.0; E_p_sp2 = 0.0; E_p_sp3 = 0.0; E_p_sp4 = 0.0
  E_p_L = 0.0
