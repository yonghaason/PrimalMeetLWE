...
This is written in c++, so you need to compile c++ as following:
...
This will make executables `meet_lwe_matrix` in the same directory.

Then the experiment in the paper can be reproduced as follows:
